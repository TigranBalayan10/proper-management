      ...
      <div className="pt-24 pl-7">
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <p className="uppercase tracking-loose w-full">Proper Management App</p>
          ...
          <div className=" flex flex-row gap-6 w-full md:w-3/5 py-6 text-center">
            ...
            <div className="block p-6  rounded-lg shadow-md" id="card-home">
              ...
              <Link to="/login" className={button}>Business Login</Link>
            </div>
          </div>
        </div>
      </div>
